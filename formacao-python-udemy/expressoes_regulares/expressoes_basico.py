...
info = re.findall('[Ae3]',texto1) # buscando 'A e 3'
info2 = re.findall('[A-Z]',texto1) # buscando de A a Z maiúsculo 
info3 = re.findall('[a-z]',texto1) # buscando de 'a' até 'z' minúsculo
info4 = re.findall('[0-9]',texto1) # buscando de 0 até 9
info5 = re.findall('[A-Za-z]',texto1) # buscando de A a Z maiúsculo e de a até z minúsculo
print(info)
print(info2)
print(info3)
print(info4)
...
texto2 = 'existem 64 predios com 700 metros'
info = re.findall('predio|metros',texto2) # '|' significa OU
print(info)
